...
import { getNotifications, markAllNotificationsRead, markNotificationRead, Notification } from "../../services/notificationService";
import {
...
export default function TeacherNotifications() {
  ...
  const loadNotifications = async (isRefresh = false) => {
    try {
      ...
      const data = await getNotifications({ teacherId, limit: 100 });
            ...
            {!permissionGranted && (
              <View style={styles.pushCard}>
                ...
                <View style={styles.pushCardContent}>
                  ...
                  <Text style={styles.pushCardText}>Get instant updates for classes, results, and attendance.</Text>
                </View>
                <TouchableOpacity
