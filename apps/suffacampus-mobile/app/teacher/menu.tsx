...
export default function TeacherMenuScreen() {
  ...
  const academicItems: MenuItem[] = [
    { icon: "calendar-check", label: "Attendance", route: "/teacher/attendance", color: "#4C6EF5" },
    { icon: "file-document-edit", label: "Assignments", route: "/teacher/assignments", color: "#10B981" },
    { icon: "help-circle", label: "Question Bank", route: "/teacher/add-question", color: "#8B5CF6" },
  ];

  const servicesItems: MenuItem[] = [
    { icon: "chart-box", label: "Results", route: "/teacher/results", color: "#06B6D4" },
    { icon: "calendar-clock", label: "Schedule", route: "/teacher/schedule", color: "#EF4444" },
    { icon: "book-open-variant", label: "Library", route: "/teacher/library", color: "#EC4899" },
    {
      icon: "bell-outline",
      label: "Notifications",
    ...
    <SafeAreaView style={styles.wrapper}>
      ...
      <SafeAreaView edges={["bottom"]} style={styles.floatingNavContainer}>
        <View style={styles.floatingNav}>
          <Pressable style={styles.navItem} onPress={() => router.push("/teacher/dashboard" as any)}>
            {({ pressed }) => (
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 32, fontWeight: "800", color: "#1A1A1A", marginBottom: 4 },
  headerSubtitle: { fontSize: 14, fontWeight: "500", color: "#94A3B8" },
